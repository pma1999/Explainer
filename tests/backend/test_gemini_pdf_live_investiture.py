"""Live Gemini integration: Investiture PDF → segmentador (Pro) → recorte → explainer (Flash Lite).
...
def test_live_gemini_flash_segment_investiture_pdf_and_explainer_first_part():
    """End-to-end API calls: Pro segments the numbered PDF; Flash Lite explainer runs on first sub-PDF only."""
